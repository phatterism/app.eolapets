...
<svelte:head>
	...
	<title>Thanks for signing up with Eola Pets</title>
</svelte:head>
								...
								>
									<tr>
										...
										>
											...
											>
												Before your signup can be submitted, please verify your email address using
															...
															>
																<tbody>
																	<tr>
																		...
																		>
																			<a
																				href={`${hostName}/signup/verify?id=${userId}&code=${verificationCode}`}
																				target="_blank"
											...
											<p
												style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"
											>
												Thank you for verifying and applying!
											</p>
										</td>
									</tr>
								</table>
