<script>
	const headerImageUrl =
		'https://lh3.googleusercontent.com/p/AF1QipNl3RhinzGgAVnMKQl5H3Cw1CflfsAsVCPPjydl=w1040-h480-n';

	export let /** @type {string} */ givenName;
	export let /** @type {string} */ emailAddress;
	export let /** @type {string} */ hostName;
	// export let /** @type {string} */ postalCode;
	// export let /** @type {string} */ userID;
	// export let /** @type {string} */ verificationCode;
</script>

<svelte:head>
	<meta name="viewport" content="width=device-width" />
	<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />
	<title>Thanks for subscribing to Eola Pets</title>
</svelte:head>
...
>
	<span
		...
		>You've been subscribed to the Eola Pets Newsletter. Look out every first Wednesday for all the
		good news!</span
	>
	<table
		role="presentation"
			...
			>
				...
				>
					...
					>
						...
						<tr
							><td style="padding:0"
								><img src={headerImageUrl} alt="Eola Pets Header" width="100%" />
							</td></tr
						>
						<tr>
							<td
								...
								>
									<tr>
										...
										>
											...
											>
												You've been subscribed to the Eola Pets Newsletter. Look out every first
												Wednesday for all the good news!
											</p>
											<!-- <table
												role="presentation"
												border={0}
											...
											<p
												style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"
											>
												We hope you find value in our newsletter. Thanks.
											</p>
										</td>
									</tr>
								</table>
							...
							<tr>
								...
								>
									<span
										...
										>Eola Pets, 420 E Church St., Downtown Orlando FL 32801</span
									>
									<br /> Don't like these emails?
									<a
										href={`${hostName}/signup/unsubscribe?emailAddress=${encodeURI(emailAddress)}`}
...
<ul class="article img-responsive"><ol /></ul>
